...
export default class Application extends React.Component{
  render(){
    return <div className={ApplicationStyles.app}>
      <div className={ApplicationStyles.app_header}>
        <AppBar title='Document Extraction Application'>
          <Navigation type='horizontal'>
            <Link to={"/extract-requests"}>All Requests</Link>
          </Navigation>
        </AppBar>
      </div>
      <div className={ApplicationStyles.app_content}>
        <Switch>
          ...
          <Route path="/extract-requests/:extract_request_id/train/:document_id" exact component={AnnotatePage} />
        </Switch>
      </div>
